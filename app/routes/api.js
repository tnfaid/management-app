...
module.exports = function(router) {
    ...
    router.post('/users', function(req, res) {
        ...
        if (req.body.username === null || req.body.username === '' || req.body.password === null || req.body.password === '' || req.body.email === null || req.body.email === '' || req.body.name === null || req.body.name === '') {
            res.json({ success: false, message: 'Ensure username, email, and password were provided okek' });
        } else {
            ...
            user.save(function(err) {
                if (err) {
                    ...
                    var email = {
                        from: 'MEAN Stack Staff, tifny210@gmail.com',
                        to: [user.email, 'nurfaidahtitik@gmail.com'],
    ...
    router.post('/checkusername', function(req, res) {
        User.findOne({ username: req.body.username }).select('username').exec(function(err, user) {
            if (err) {
                ...
                var email = {
                    from: 'MEAN Stack Staff, nurfaidahtitik@gmail.com',
                    to: 'tifsny.210@gmail.com',
